...
export function Footer() {
  return (
    <footer className="mx-auto flex w-full max-w-[1080px] flex-col items-center gap-3 px-6 py-8 text-center font-[family-name:var(--font-geist-mono)] text-xs text-muted-foreground md:px-8">
